...
function stringToNumber(str) {
  ...
  return (stringToNumber = Number(str));
}
...
function isAlmostSame(num1, num2) {
  ...
  console.log(num1 - num2, num2 - num1, Number.EPSILON);
  {
    return num1 - num2 <= Number.EPSILON;
  }

  //   {
  //     if (num1 - num2 < Number.EPSILON < num2 - num1) {
  //       return `num1 and num2 Практически равные`;
  //     } else if (num1 - num2 === Number.EPSILON) {
  //       return `num1 and num2 равны`;
  //     } else {
  //       return `num1 and num2 Не равны`;
  //     }
  //   }
}
...
function isSafeInteger(num) {
  ...
  console.log(num);
  return Number.MAX_SAFE_INTEGER >= num <= Number.MIN_SAFE_INTEGER;
}
